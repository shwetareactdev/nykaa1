...
import lakme from '../ProductComponent/Images/lakmegif1_files/lakme.jpg';
import lakmetitle from '../ProductComponent/Images/lakmegif1_files/lakmetitle.png';
import lakmetitle3 from '../ProductComponent/Images/lakmegif1_files/lakmetitle3.jpg';
...
const Lakme = () => {
  const products = [
    ...
    {
      id: 5, src: loreal4, name: 'L\'Oreal Natural Vitamin C Pure Serum', price: '₹800', mrp: '₹850', discount: '6% Off',
      description: "Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha taximy chia microdosing tilde DIY. XOXO fam indxgo juiceramps cornhole raw denim forage brooklyn. Everyday carry +1 seitan poutine tumeric. Gastropub blue bottle austin listicle pour-over, neutra jean shorts keytar banjo tattooed umami cardigan.",
      rating: 4,
      ratingCount: 50,
    },
    {
      id: 6, src: loreal4, name: 'L\'Oreal Natural Vitamin C Pure Serum', price: '₹800', mrp: '₹850', discount: '6% Off',
      description: "Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha taximy chia microdosing tilde DIY. XOXO fam indxgo juiceramps cornhole raw denim forage brooklyn. Everyday carry +1 seitan poutine tumeric. Gastropub blue bottle austin listicle pour-over, neutra jean shorts keytar banjo tattooed umami cardigan.",
      rating: 4,
      ratingCount: 50,
    },
    {
      id: 7, src: loreal4, name: 'L\'Oreal Natural Vitamin C Pure Serum', price: '₹800', mrp: '₹850', discount: '6% Off',
      description: "Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha taximy chia microdosing tilde DIY. XOXO fam indxgo juiceramps cornhole raw denim forage brooklyn. Everyday carry +1 seitan poutine tumeric. Gastropub blue bottle austin listicle pour-over, neutra jean shorts keytar banjo tattooed umami cardigan.",
      rating: 4,
      ratingCount: 50,
    },
    {
      id: 8, src: loreal4, name: 'L\'Oreal Natural Vitamin C Pure Serum', price: '₹800', mrp: '₹850', discount: '6% Off',
      description: "Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha taximy chia microdosing tilde DIY. XOXO fam indxgo juiceramps cornhole raw denim forage brooklyn. Everyday carry +1 seitan poutine tumeric. Gastropub blue bottle austin listicle pour-over, neutra jean shorts keytar banjo tattooed umami cardigan.",
      rating: 4,
      ratingCount: 50,
    },
    {
      id: 9, src: loreal4, name: 'L\'Oreal Natural Vitamin C Pure Serum', price: '₹800', mrp: '₹850', discount: '6% Off',
      description: "Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha taximy chia microdosing tilde DIY. XOXO fam indxgo juiceramps cornhole raw denim forage brooklyn. Everyday carry +1 seitan poutine tumeric. Gastropub blue bottle austin listicle pour-over, neutra jean shorts keytar banjo tattooed umami cardigan.",
      rating: 4,
      ratingCount: 50,
    },
    {
      id: 10, src: loreal4, name: 'L\'Oreal Natural Vitamin C Pure Serum', price: '₹800', mrp: '₹850', discount: '6% Off',
      description: "Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha taximy chia microdosing tilde DIY. XOXO fam indxgo juiceramps cornhole raw denim forage brooklyn. Everyday carry +1 seitan poutine tumeric. Gastropub blue bottle austin listicle pour-over, neutra jean shorts keytar banjo tattooed umami cardigan.",
      rating: 4,
      ratingCount: 50,
    },
    {
      id: 11, src: loreal4, name: 'L\'Oreal Natural Vitamin C Pure Serum', price: '₹800', mrp: '₹850', discount: '6% Off',
      description: "Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha taximy chia microdosing tilde DIY. XOXO fam indxgo juiceramps cornhole raw denim forage brooklyn. Everyday carry +1 seitan poutine tumeric. Gastropub blue bottle austin listicle pour-over, neutra jean shorts keytar banjo tattooed umami cardigan.",
      rating: 4,
      ratingCount: 50,
    },
  ...
  return (
    <div className="loreal-container">
      ...
      <div className="title-section">
        <table>
          <tr>
            <td><img src={lakme} alt="lakme Title" className="lakmetitle1-image" /></td>
            <td><img src={lakmetitle} alt="lakme Title" className="lakmetitle2-image" /></td>
            <td><img src={lakmetitle3} alt="lakme Title" className="lakmetitle2-image" /></td>
          </tr>
        </table>
      </div>
      {/* Page Heading */}
      <h2 className="text-center mb-4">Buy Lakme Products Online</h2>
