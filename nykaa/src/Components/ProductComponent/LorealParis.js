  ...
  return (
    <div className="loreal-container">
      ...
      <div className="title-section">
        <table>
          <tr>
            <td><img src={lakmetitle} alt="Loreal Paris Title" className="loreal-title-image" /></td>
            <td><img src={lakmetitle3} alt="Loreal Small Title" className="loreal-title-small" /></td>
          </tr>
        </table>
      </div>
      {/* Page Heading */}
      <h2 className="text-center mb-4">Buy Loreal Paris Products Online</h2>
